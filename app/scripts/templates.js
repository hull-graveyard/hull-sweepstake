...
this["Hull"]["templates"]["instant_win/buttons"] = function (Handlebars,depth0,helpers,partials,data) {
...
this["Hull"]["templates"]["instant_win/intro"] = function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [2,'>= 1.0.0-rc.3'];
...
this["Hull"]["templates"]["instant_win/lost"] = function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [2,'>= 1.0.0-rc.3'];
helpers = helpers || Handlebars.helpers; data = data || {};
  


  return "<div class=\"hull-instant hull-instant--lost\">\n  <div class=\"hull-instant-result\">\n    <h1 class=\"hull-instant-result__title\">You Lose...</h1>\n    <p class=\"hull-instant-result__description\">Come back tomorrow!</p>\n  </div>\n</div>\n";
  };

this["Hull"]["templates"]["instant_win/played"] = function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [2,'>= 1.0.0-rc.3'];
helpers = helpers || Handlebars.helpers; data = data || {};
  


  return "<div class=\"hull-instant hull-instant--played\">\n  <div class=\"hull-instant-result\">\n    <h1 class=\"hull-instant-result__title\">You've already played today!</h1>\n    <p class=\"hull-instant-result__description\">Come back tomorrow!</p>\n  </div>\n</div>\n";
  };

this["Hull"]["templates"]["instant_win/won"] = function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [2,'>= 1.0.0-rc.3'];
helpers = helpers || Handlebars.helpers; data = data || {};
...
this["Hull"]["templates"]["instant_win/working"] = function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [2,'>= 1.0.0-rc.3'];
helpers = helpers || Handlebars.helpers; data = data || {};
